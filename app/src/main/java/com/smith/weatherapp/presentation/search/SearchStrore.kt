...
import com.smith.weatherapp.domain.usecase.SearchCityUseCase
import com.smith.weatherapp.presentation.search.SearchStore.Intent
import com.smith.weatherapp.presentation.search.SearchStore.Label
import com.smith.weatherapp.presentation.search.SearchStore.State
...
class SearchStoreFactory @Inject constructor(
    ...
    fun create(reasonToOpen: ReasonToOpen): SearchStore =
        object : SearchStore, Store<Intent, State, Label> by storeFactory.create(
            ...
            executorFactory = { ExecutorImpl(reasonToOpen) },
            reducer = ReducerImpl
        ) {}
    ...
    private inner class ExecutorImpl(private val reasonToOpen: ReasonToOpen) :
